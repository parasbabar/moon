...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.getAge) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named getAge');
    }
    ...
    this.circuits = {
      verifyAge: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyAge',
                                     ...
                                     'age_verify.compact line 58 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      resetVerification: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('resetVerification',
                                     'argument 1 (as invoked from Typescript)',
                                     'age_verify.compact line 69 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      getStatus: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`getStatus: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getStatus',
                                     'argument 1 (as invoked from Typescript)',
                                     'age_verify.compact line 78 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._getStatus_0(context, partialProofData);
      ...
      getThreshold: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getThreshold',
                                     'argument 1 (as invoked from Typescript)',
                                     'age_verify.compact line 86 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(initialThreshold_0) === 'bigint' && initialThreshold_0 >= 0n && initialThreshold_0 <= 255n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 ...
                                 'age_verify.compact line 40 char 1',
                                 'Uint<0..256>',
                                 initialThreshold_0)
    }
  ...
  _getAge_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.getAge(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
      __compactRuntime.typeError('getAge',
                                 'return value',
                                 'age_verify.compact line 21 char 1',
                                 'Uint<0..256>',
                                 result_0)
    }
  ...
  _verifyAge_0(context, partialProofData) {
    const age_0 = this._getAge_0(context, partialProofData);
    __compactRuntime.assert(age_0
                            ...
                            'Age does not meet the required threshold');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
  ...
  _getStatus_0(context, partialProofData) {
...
const _dummyContract = new Contract({ getAge: (...args) => undefined });
